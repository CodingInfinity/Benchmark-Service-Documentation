...
The lower level services required by the addDataset service to either check the
pre-conditions or address the post-conditions are shown in Figure \ref{fig:addDatasetFR}
\begin{figure}[H]
  \begin{center}
  \includegraphics[scale=0.6]{../Diagrams and Charts/Test Data/AddDatasetFunctionalRequirements.jpg}
...
\begin{figure}[H]
 ...
 The service will delete the Dataset meta data as well as the stored files
...
\subsubsection {Update dataset metadata}
